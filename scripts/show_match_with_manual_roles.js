...
function main() {
  ...
  // Manual role assignment as specified
  // Radiant: Chen, Troll Warlord, Earthshaker, Doom, Snapfire
  // User wants: Troll-Carry, Earthshaker-Mid, Doom-Offlane, Snapfire-Soft, Chen-Hard
  
  // Dire: Anti Mage, Enigma, Queen Of Pain, Monkey King, Oracle
  // User wants: Anti-Mage-Carry, Queen Of Pain-Mid, Enigma-Offlane, Monkey King-Soft, Oracle-Hard

  const radiantHeroRoles = {
    "Chen": "hardsupport",
    "Troll Warlord": "carry",
    "Earthshaker": "mid",
    "Doom": "offlane",
    "Snapfire": "softsupport"
  };
  ...
  const radiantRoles = rHeroes.map((h) => radiantHeroRoles[h] || "carry");
  const direRoles = dHeroes.map((h) => direHeroRoles[h] || "carry");
  ...
  console.log("\n" + "=".repeat(100));
  console.log("MANUAL ROLE ASSIGNMENTS");
  console.log("=".repeat(100));
